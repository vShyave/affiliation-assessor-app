...
import calcModule from 'dst-enketo-core/src/js/calculate';
calcModule.update = () => {
    console.log( 'Calculations disabled.' );
};
// Completely disable instanceID and deprecatedID population in Enketo Core
import { FormModel } from 'dst-enketo-core/src/js/form-model';
...
import preloadModule from 'dst-enketo-core/src/js/preload';
preloadModule.init = () => {
