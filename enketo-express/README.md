...
Note the 'Powered by Enketo' footer requirement as explained in [dst-enketo-core](https://github.com/enketo/dst-enketo-core#license). This requirement is applicable to all Enketo apps, including this one, unless an exemption was granted.
