...
function _submitRecord(survey) {
    ...
    return fileManager.getCurrentFiles()
        ...
        .then(result => {
            ...
            if (level == "success"){
                msg = result.message ? result.message : "Form Submitted Successfully";
            } else {
                msg = result.message ? result.message : "Submissison Failed";
            }
        ...
        .then(() => {
            ...
            if (level === 'success') {                
                ...
                msg = result.message ? result.message : "Submission Failed";
