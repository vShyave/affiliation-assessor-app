          ...
          inspectionData?.length ? (
            inspectionData.map((el, idx) => {
              return <div className="w-full bg-tertiary flex flex-col p-7 lg:w-[90%] font-medium overflow-scroll rounded-[8px] mb-8" key={idx}>
                <div className="flex flex-col pb-4">
                  ...
                  <div className="mt-2 text-secondary text-[18px] font-medium">{ el.institute?.district || 'NA' }</div>
                </div>
                ...
                <div className="flex flex-col pt-4">
                  ...
                  <div className="mt-2 text-secondary text-[18px] font-medium">{ el.date || 'NA' }</div>
                </div>
              </div>
            })
          ) : (
            <div className="flex flex-col">
              <div className="w-full bg-tertiary flex flex-col p-7 lg:w-[90%] font-medium overflow-scroll rounded-[8px]">
                <div className="text-secondary text-[24px] text-center font-medium">No upcoming assessments found!</div>
              </div>
            </div>
          )
        }
