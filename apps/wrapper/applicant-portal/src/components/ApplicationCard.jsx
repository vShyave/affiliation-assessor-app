...
const ApplicationCard = (props) => {
    return  (
        <Card moreClass="flex flex-col border-gray-100 m-3 gap-3 w-[300px] border-[1px] drop-shadow" key={props.application.form_id}>
            ...
            <div className='flex'>
                <Button moreClass="text-primary-500 font-bold uppercase border-gray-500 text-primary-400" style={{backgroundColor: '#fff' }} text="View Application "></Button>
            </div>
        </Card>
    )
}
