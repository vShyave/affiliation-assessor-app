...
export default function OnGroundInspectionAnalysis() {
  ...
  useEffect(() => {
    fetchGetOnGroundAssessorData();
  }, []);
  const fetchGetOnGroundAssessorData = async () => {
    try {
  ...
  formsList.forEach((e) => {
    var formsData = {
      Applicant: e.institute.name + ", " + e.institute.district,
      "Form name": e.form_name,
      Assessor: e.assessor.name,
      "Assisting Assessor": e.assessor.assisstant,
      "Published on": e.submitted_on,
    };
