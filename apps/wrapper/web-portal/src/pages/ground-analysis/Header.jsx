      ...
      <div className="container py-2 mx-auto h-[100px]">
        <div className="flex flex-row justify-center justify-between bg-white">
          <div className="flex flex-row gap-4">
            <img className="logo" alt="logo1" />
            <div className="inline-block h-[76px] min-h-[1em] w-0.5 border opacity-100 dark:opacity-50"></div>
            <img className="logo" alt="logo1" />
          </div>
          <div>
      ...
      <div className="container mx-auto h-[64px] flex justify-between items-center">
        <div className="flex bg-white hidden md:contents">
          <ul className="flex md nav-items text-gray-500 gap-4">
            <Link to="/">
              <li className="bg-blue-800 rounded-md flex items-center justify-center h-8 w-8 hover:cursor-pointer">
                <AiFillHome className="text-white text-xl" />
              </li>
            </Link>
            <Link>
              <li className="hover:text-blue-600 hover:cursor-pointer font-medium">
                DASHBOARD
              </li>
            </Link>
