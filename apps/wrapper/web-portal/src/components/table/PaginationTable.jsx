  ...
  return (
    <>
      ...
      <div className="flex justify-center font-normal text-[16px] gap-8 p-8">
        ...
        <span className="font-bold">
          Go to page: {' '}
          <input className=" rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" type="number"  defaultValue={pageIndex + 1}
            onChange = {(e) =>{
