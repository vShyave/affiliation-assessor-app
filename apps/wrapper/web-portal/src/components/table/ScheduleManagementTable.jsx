  ...
  return (
    <>
      ...
      <div className="overflow-x-auto">
        ...
        >
          <thead className="text-s font-bold text-white uppercase bg-blue-800 dark:bg-gray-700 dark:text-gray-400">
          ...
          <tbody {...getTableBodyProps()}>
            {page?.map((row, index) => {
              ...
              return (
                <tr
                  {...row.getRowProps()}
                  className="bg-white border-b dark:bg-gray-800 even:bg-gray-200 odd:bg-gray-100 dark:border-gray-700 cursor-pointer"
