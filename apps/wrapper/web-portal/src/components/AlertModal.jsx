  ...
  return (
      ...
      <>
        <div className='flex justify-center items-center fixed inset-0 bg-opacity-25 backdrop-blur-sm'>
            <div className='flex justify-between p-4 rounded-xl shadow-xl border border-gray-400 bg-gray-100 max-w-[580px] max-h-[300px]'>
                <div className='flex flex-col gap-4 min-w-[400px]'>
                    <div className='title flex font-bold'>
                     ...
                     <div className='footer flex flex-row justify-between'>
                        ...
                        <button onClick={()=>actionFunction(actionProps)} className="border border-blue-500 text-white bg-blue-500 w-[140px] h-[40px] font-medium rounded-[4px]">{actionButtonLabel}</button>
                    </div>
                </div>
            </div>
        </div>
