                                      ...
                                      <div className="bg-gray-100 flex flex-col py-16 w-full h-screen">
                                          <div className="flex flex-col container items-center mx-auto">
                                              ...
                                              <div className="flex container justify-center mx-auto">
                                                {Object.keys(formErrors).length === 0 && isSubmit ? (<div className="border-2 border-green-800 bg-green-100 text-green-800 font-bold p-4">Logged in Successfully</div>) :
                                                      ...
                                                      <div className="sm:col-span-4">
                                                        <label htmlFor="email" className="block mt-6 text-left leading-6 text-gray-800" >
                                                          ...
                                                          <div className="mt-4">
                                                              ...
                                                              <p className="flex justify-center p-8 text-gray-600"> Create an account, <a href="/signup" className="text-blue-700 ml-2">Sign up</a> </p>
                                                          </div>
                                                    </div> 
                                                </div>
                                            </form>                                     
