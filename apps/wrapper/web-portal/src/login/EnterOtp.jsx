...
export default function EnterOtp() {
                  return (
                            <>
                                <div className="flex flex-col py-16 bg-gray-100 w-full h-screen">
                                                 ...
                                                 <label htmlFor="email" className="p-2 block mt-6 text-left leading-6 text-gray-800">
                                                   Enter OTP
                                                    ...
                                                    <div className="p-2">
                                                        ...
                                                        <button className="mt-4 border border-blue-900 text-white bg-blue-900 w-[400px] py-3 font-medium rounded-[4px]">Sign up</button>
